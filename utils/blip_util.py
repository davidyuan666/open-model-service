...
class BlipUtil:
    ...
    def read_images_from_directory(self,image_directory: str) -> list:
        """
    ...
    def read_with_pil(self,list_of_images: list, resize=False) -> list:
        """
    ...
    def prep_images(self,pil_images) -> list:
        """
        ...
        # Transform Images
        t_images = [transform(img).unsqueeze(0).to(self.device) for img in pil_images]
        return t_images
